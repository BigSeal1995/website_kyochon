...
<head>
    ...
    <style>
        ...
        *{padding:0;margin:0;}
        ...
        /* content */
        /* pw_search_box */      
        .pw_search_box{width:800px;height:600px;border:1px solid #888888;margin:0 auto 103px;position:relative;background-color:white;}
        .pw_search_box legend{margin:-1px;width:0;height:0;overflow:hidden;}
        ...
        .bottom_id{width:480px;height:40px;background-color:#f8f8f8;padding:0 0 0 38px;box-sizing:border-box;margin:39px 0 40px 0;}
        .bottom_name{width:480px;height:40px;background-color:#f8f8f8;padding:0 0 0 38px;box-sizing:border-box;margin:0 0 40px 0;}
        .bottom_pn{width:480px;height:40px;background-color:#f8f8f8;padding:0 0 0 38px;box-sizing:border-box;margin:0 0 40px 0;}
        ...
        /* button */
        .pw_search_button{border:0px;width:150px;height:40px;background-color:#fd8205;font-size:20px;color:white;font-family:"나눔바른고딕";font-weight:bold;margin:39px auto 0 166px;cursor: pointer;cursor: pointer}
...
<body>
    ...
    <div class="content">
        <div class="pw_search_box">
            <form action="find_pwd_ok.php" name="pw_search_content" id="pw_search_content" method="post">        
                <div class="top_box">
                    <p class="top_box_txt">비밀번호 찾기</p>
                </div>
                <div class="bottom_box">
                    <fieldset class="bottom_box_enter">
                    <legend>회원정보입력</legend>
                        
                        <input class="bottom_id" type="text" name="uid" id="uid" onFocus="this.value='';return true;" value="아이디 입력">
                        ...
                        <button class="pw_search_button" type="button" onclick="form_check(this.form)">비밀번호 찾기</button>
                    </fieldset>
                </div>
            </form>            
        </div>
