...
$sql="select pwd from members where uid='$uid' and uname='$uname' and mobile='$mobile' and email='$email';";
...
<head>
    ...
    <style>
        ...
        *{padding:0;margin:0;}
        ...
        /* content */
        /* id_search_box */      
        .pwd_search_box{width:800px;height:600px;border:1px solid #888888;margin:0 auto 103px;position:relative;background-color:white;}
        .pwd_search_box legend{margin:-1px;width:0;height:0;overflow:hidden;}
        ...
        .find_pwd{color:#f03a64;font-weight:bold;}
        .buttonl{position:absolute;left:165px;}
...
<body>
    ...
    <div class="content">
        <div class="pwd_search_box">
            <form action="pwd_search_content" name="pwd_search_content" id="pwd_search_content">        
                <div class="top_box">
                    <p class="top_box_txt">비밀번호 찾기</p>
                </div>

                <?php if($g_pwd && $uid!="admin"){ ?>
                <div class="bottom_box">
                    <p class="bottom_box_txt">회원가입 시 사용한 비밀번호는 <span class="find_pwd"><?php echo $g_pwd ?></span>입니다.</p>                    
                    <button type="button" class="buttonl" onclick="location.href='login.php'">로그인</button>
                </div>          
                <?php } else if(!$g_pwd || $uid=="admin"){ ?>
                <div class="bottom_box">
