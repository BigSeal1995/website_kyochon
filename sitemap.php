...
<head>
    ...
    <style>
        ...
        *{padding:0;margin:0;}
        ...
        /* content */
        .content{width:1000px;height:700px;margin:auto;font-family:"나눔바른고딕"}
        .sitemap{width:600px;height:150px;border-bottom:1px solid #985b10;margin:auto;font-size:34px;color:#fd8205;text-align: center;margin-bottom:60px;padding-top:55px;box-sizing: border-box;}
        .sitemap_content{padding-left:9%;}
        .sitemap_content>ul>li{float:left;font-size:20px;font-weight:bold;text-align: center;width:15%;}
        .sitemap_content>ul>li>ul>li{font-size:15px;text-align:center;line-height:70px;}
    ...
    <script>
        ...
        /* content */
        $(".sitemap_content a").hover(function(){
            $(this).css("color","red");
        },function(){
            $(this).css("color", '');
        });
...
<body>
    <div class="skip_menu">
        <a href="#none">교촌스토리 바로가기</a>
        <a href="#none">안내사항 바로가기</a>
        <a href="#none">메뉴 바로가기</a>
        <a href="#none">매장안내 바로가기</a>
        <a href="#none">고객센터 바로가기</a>
        <a href="#none">온라인주문 바로가기</a>
    </div>
    ...
    <div class="content">
        ...
        <div class="sitemap_content">
            <ul>
                <li><a href="#none">교촌스토리</a>
                    <ul>
                        <li><a href="#none">CEO인사말</a></li>
                        <li><a href="#none">교촌스토리</a></li>
                        <li><a href="#none">행복 채움 프로젝트</a></li>
                        <li><a href="#none">나만의 레시피</a></li>
                        <li><a href="#none">PR센터</a></li>
                    </ul>
                </li>
                <li><a href="#none">안내사항</a>
                    <ul>
                        <li><a href="#none">공지사항</a></li>
                        <li><a href="#none">이벤트</a></li>
                    </ul>
                </li>
                <li><a href="menu_chicken.php">메뉴</a>
                    <ul>
                        <li><a href="menu_chicken.php">치킨</a></li>
                        <li><a href="menu_side.php">사이드</a></li>
                        <li><a href="menu_voucher.php">상품권</a></li>
                    </ul>
                </li>
                <li><a href="#none">매장안내</a>
                    <ul>
                        <li><a href="#none">국내매장</a></li>
                        <li><a href="#none">해외매장</a></li>
                    </ul>
                </li>
